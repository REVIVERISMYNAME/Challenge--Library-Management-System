			...
			?>
				<form method="POST" enctype="multipart/form-data">
					<div>
						...
						<input type="text" name="user_email_address" id="user_email_address" value="<?php echo $row['user_email_address']; ?>" />
					</div>
					<div>
						<label>Password</label>
						<input type="password" name="user_password" id="user_password" value="<?php echo $row['user_password']; ?>" />
					</div>
					<div>
					...
					<div>
						...
						<input type="text" name="user_contact_no" id="user_contact_no" value="<?php echo $row['user_contact_no']; ?>" />
					</div>
					<div>
						<label>User Address</label>
						<textarea name="user_address" id="user_address"><?php echo $row['user_address']; ?></textarea>
					</div>
					<div>
						<label>User Photo</label><br />
						<input type="file" name="user_profile" id="user_profile" />
						<br />
						<span>Only .jpg & .png image allowed. Image size must be 225 x 225</span>
						<br />
						<input type="hidden" name="hidden_user_profile" value="<?php echo $row['user_profile']; ?>" />
						<img src="upload/<?php echo $row['user_profile']; ?>" width="100"/>
					</div>
					<div>
